...
fs.writeFileSync(__dirname + '/../css/mathpix_styles.css', mathpixStyles);
...
program
    ...
    .action((opts) => {
        ...
        const treeDirectory = createTree(inputDirectory);
        ...
        if (!DEV_MODE) {
            fs.copySync(path.join(__dirname, '..', 'css'), path.join(outputDirectory, 'css'));
        }
